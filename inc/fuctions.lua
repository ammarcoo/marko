...
▀█████████▄           ██       ████████
  ██                    ██▄████████▀ │marko ﹏ @UU_IV
│@UU_IV
تم تطوير وبرمجة السورس من قبل سونيك ᐂ .
│SONIC ‿ @UU_IV
#-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(marko..":NameBot:")
...
var = 'مطور اساسي' 
elseif redis:sismember(marko..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(marko..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(marko..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(marko..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(marko..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(marko..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(marko..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(marko..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(marko..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(marko..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(marko..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(marko..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(marko..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(marko..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(marko..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(marko..':SUDO_BOT:')
message = '• ** قائمه الـمـطـوريـن : \n\n`• مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(marko..'username:'..v)
local count = redis:scard(marko..'mtwr_count'..v)
...
local monsha = redis:smembers(marko..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n• قائمه المدراء :*\n\n'
local list = redis:smembers(marko..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(marko..'admins:'..msg.chat_id_)
...
local list = redis:smembers(marko..'whitelist:'..msg.chat_id_)
...
if redis:sismember(marko..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(marko..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(marko..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(marko..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(marko..'gban_users')
...
local list = redis:smembers(marko..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(marko..':Filter_Word:'..msg.chat_id_,word) then 
return  "• **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(marko..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(marko..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(marko..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(marko..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(marko..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(marko..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(marko..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(marko..'group:ids')
message = '• **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(marko..'group:name'..v)
if info then 
...
redis:del(
marko..'group:add'..id_group,
marko..'lock_link'..id_group, 
marko..'lock_id'..id_group,
marko..'lock_spam'..id_group, 
marko..'lock_webpage'..id_group,
marko..'lock_markdown'..id_group,
marko..'lock_flood'..id_group,
marko..'lock_bots'..id_group,
marko..'mute_forward'..id_group,
marko..'mute_contact'..id_group,
marko..'mute_location'..id_group,
marko..'mute_document'..id_group,
marko..'mute_keyboard'..id_group,
marko..'mute_game'..id_group,
marko..'mute_inline'..id_group,
marko..'lock_username'..id_group,
marko..'num_msg_marko'..id_group,
marko..'replay'..id_group
)
redis:srem(marko..'group:ids',id_group)
end
...
redis:hset(marko..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(marko..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(marko..'group:add'..msg.chat_id_) then  return '• **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(marko..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(marko..':addnumberusers') or 0)
...
local lock_service = redis:get(marko..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(marko..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(marko..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
marko..'group:add'..msg.chat_id_,true,
marko..'lock_link'..msg.chat_id_,true, 
marko..'lock_id'..msg.chat_id_,true,
marko..'lock_spam'..msg.chat_id_,true,
marko..'lock_webpage'..msg.chat_id_,true,
marko..'lock_markdown'..msg.chat_id_,true,
marko..'lock_flood'..msg.chat_id_,true,
marko..'lock_bots'..msg.chat_id_,true,
marko..'mute_forward'..msg.chat_id_,true,
marko..'mute_contact'..msg.chat_id_,true,
marko..'mute_location'..msg.chat_id_,true,
marko..'mute_document'..msg.chat_id_,true,
marko..'mute_keyboard'..msg.chat_id_,true,
marko..'mute_game'..msg.chat_id_,true,
marko..'mute_inline'..msg.chat_id_,true,
marko..'lock_username'..msg.chat_id_,true,
marko..'num_msg_marko'..msg.chat_id_,5, 
marko..'replay'..msg.chat_id_,true
)

redis:sadd(marko..'group:ids',msg.chat_id_) 
redis:sadd(marko..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(marko..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(marko..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(marko..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(marko..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(marko..'username:'..UserID,'username',Resolv)
redis:sadd(marko..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(marko..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(marko..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(marko..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(marko..'username:'..UserID,'username',Resolv)
redis:sadd(marko..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(marko..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(marko..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(marko..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(marko..'username:'..UserID, 'username', Resolv)
redis:sadd(marko..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(marko..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(marko..'whitelist:'..ChatID,UserID)
...
if redis:sismember(marko..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(marko..'username:'..UserID, 'username', Resolv)
redis:sadd(marko..'owners:'..ChatID,UserID)
...
if redis:sismember(marko..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(marko..'username:'..UserID, 'username', Resolv)
redis:sadd(marko..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(marko..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(marko..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(marko..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(marko..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(marko..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(marko..'username:'..UserID, 'username', Resolv)
redis:sadd(marko..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(marko..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(marko..'banned:'..ChatID,UserID)
...
if redis:sismember(marko..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(marko..'username:'..UserID, 'username', Resolv)
redis:sadd(marko..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(marko..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(marko..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(marko..'username:'..UserID, 'username',Resolv)
redis:sadd(marko..'gban_users',UserID)
...
redis:srem(marko..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(marko..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(marko..'username:'..UserID, 'username', Resolv)
redis:sadd(marko..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(marko..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(marko..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(marko..'username:'..UserID, 'username', UserName)
redis:sadd(marko..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(marko..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'• **العضو » ❪ '..UserName..' ❫\n• **الايدي » ❪ `'..UserID..'` ❫\n• **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(marko..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(marko..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المدير\n") 
elseif redis:sismember(marko..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(marko..'username:'..UserID, 'username', Resolv)
redis:sadd(marko..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(marko..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(marko..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'• **العضو » '..USERNAME..' \n• ** الايدي » (`'..UserID..'`)\n• **انه بالتأكيد ليس مطور \n') end
redis:srem(marko..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(marko..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(marko..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(marko..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(marko..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*•*` اعدادات المجموعه :` \n"
.."\n• التعديل «» "..(redis:get(marko..'lock_edit'..msg.chat_id_) or 'false')
.."\n• الروابط «» "..(redis:get(marko..'lock_link'..msg.chat_id_) or 'false')
.."\n• التاك «» "..(redis:get(marko..'lock_tag'..msg.chat_id_) or 'false')
.."\n• المعرفات «» "..(redis:get(marko..'lock_username'..msg.chat_id_) or 'false')
.."\n• التكرار «» "..(redis:get(marko..'lock_flood'..msg.chat_id_) or 'false')
.."\n• الكلايش «» "..(redis:get(marko..'lock_spam'..msg.chat_id_) or 'false')
.."\n• الويب «» "..(redis:get(marko..'lock_webpage'..msg.chat_id_) or 'false')
.."\n• الماركدوان «» "..(redis:get(marko..'lock_markdown'..msg.chat_id_) or 'false')
.."\n• بالطرد البوتات «» "..(redis:get(marko..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n• البوتات «» "..(redis:get(marko..'lock_bots'..msg.chat_id_) or 'false')
.."\n• عدد التكرار «» "..(redis:get(marko..'num_msg_marko'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n•`اعدادات الوسائط :`\n"
.."\n*• *المتحركه «» "..(redis:get(marko..'mute_gif'..msg.chat_id_) or 'false')
.."\n• الدردشه «» "..(redis:get(marko..'mute_text'..msg.chat_id_) or 'false')
.."\n• الانلاين «» "..(redis:get(marko..'mute_inline'..msg.chat_id_) or 'false')
.."\n• الالعاب «» "..(redis:get(marko..'mute_game'..msg.chat_id_) or 'false')
.."\n• الصور «» "..(redis:get(marko..'mute_photo'..msg.chat_id_) or 'false')
.."\n• الفيديو «» "..(redis:get(marko..'mute_video'..msg.chat_id_) or 'false')
.."\n• البصمات «» "..(redis:get(marko..'mute_audio'..msg.chat_id_) or 'false')
.."\n• الصوت «» "..(redis:get(marko..'mute_voice'..msg.chat_id_) or 'false')
.."\n• الملصقات «» "..(redis:get(marko..'mute_sticker'..msg.chat_id_) or 'false')
.."\n• الجهات «» "..(redis:get(marko..'mute_contact'..msg.chat_id_) or 'false')
.."\n• التوجيه «» "..(redis:get(marko..'mute_forward'..msg.chat_id_) or 'false')
.."\n• الموقع «» "..(redis:get(marko..'mute_location'..msg.chat_id_) or 'false')
.."\n• الملفات «» "..(redis:get(marko..'mute_document'..msg.chat_id_) or 'false')
.."\n• الاشعارات «» "..(redis:get(marko..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n• الكيبورد «» "..(redis:get(marko..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*`اعدادات اخرى : `"
.."\n\n*•*الترحيب «» "..welcomex
.."\n*•*الردود «» "..replayx
...
.."\n*•*الويب «» "..(redis:get(marko..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*•*الماركدوان «» "..(redis:get(marko..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*•*البوتات بالطرد «» "..(redis:get(marko..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*•*البوتات «» "..(redis:get(marko..'lock_bots'..msg.chat_id_) or 'false')
.."\n*•*عدد التكرار «» "..(redis:get(marko..'num_msg_marko'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*اعدادات التقـييد :\n"
.."\n*•*التقييد بالتوجيه «» "..(redis:get(marko..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالصور «» "..(redis:get(marko..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالروابط «» "..(redis:get(marko..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالمتحركه «» "..(redis:get(marko..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*•*التقييد الفيديو «» "..(redis:get(marko..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
