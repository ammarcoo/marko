...
return 'اول من يكتب هذا العدد يفوز ⬅︎`'..(redis:get(amrko..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️اول من يكتب هذه السمايل يفوز ⬅︎    `'..(redis:get(amrko..':Set_Smile:'..msg.chat_id_))..'`'
end
end
